...
- **🌐 Web Search** — Barra de pesquisa Google com animação expansiva
- **⏰ Relógio digital** — Exibição HH:MM no header
- **💾 Export / Import** — Backup completo dos dados em JSON
- **🎨 Tema ObsidianFlux Purple** — Design escuro com glassmorphism, neon glows e parallax
...
3. **Ative o "Modo do desenvolvedor"** (cantosuperior direito).
...
| **Relógio** | Exibição digital no canto superior direito. |
| **Web Search** | Barra fixa no canto inferior. Ao focar, expande para o centro. |
...
| **Área vazia** | Novo atalho, Nova pasta, Editar painel |
...
| **CSS3** | Design system com variáveis, glassmorphism, animações |
| **JavaScript (Vanilla)** | Toda a lógica — zero frameworks |
| **localStorage** | Persistência de dados |
| **Google Fonts CDN** | Inter, Hanken Grotesk, Geist, Material Symbols |
| **Google S2 Favicons** | Favicons automáticos dos atalhos |
...
| `https://www.google.com/s2/favicons/*` | Buscar favicons dos atalhos |
...
- ✅ **Customizável** — Crie quantas guias e pastas quiser
- ✅ **Estiloso** — Tema escuro com glassmorphism e neon glows
